  ...
  return (
    <>
      ...
      <section className="mx-auto grid w-full max-w-7xl items-center gap-12 px-6 pt-10 pb-20 lg:grid-cols-2 lg:gap-8 lg:pt-16">
        <div>
          ...
          <p className="mt-5 max-w-md text-lg leading-relaxed text-ink-dim">
            Controle o volume de cada instrumento no seu fone direto do celular — numa
            mesa Behringer X32 ou Midas M32, sem depender do técnico de som a cada ajuste.
          </p>
      ...
      <section className="mx-auto w-full max-w-7xl px-6 py-16">
        <p className="max-w-5xl text-balance text-2xl font-medium leading-snug tracking-tight sm:text-3xl">
      ...
      <section className="mx-auto w-full max-w-7xl px-6 py-16">
        ...
        <p className="mt-10 max-w-xl font-mono text-sm leading-relaxed text-ink-faint">
          Comunicação por OSC sobre a rede local (porta 10023). O celular fala direto com
          a mesa — nada passa por servidores, nada sai da sua rede.
        </p>
      </section>
